...
namespace LevelnetAdjustment.utils {
    ...
    public class Dijkstra : ICloneable {
        ...
        private string FindMinx(Node src, Node dest, double startDist, int srcRank, string path, ref double minx) {
            var goalPath = "";
            var tmpPath1 = "," + path + ",";
    ...
    public class Edge : ICloneable {
        ...
        public Edge(String name, double weight, Node node) {
            Name = name;
            Weight = weight;
            CurrentNode = node;
        }
    ...
    public class Map : ICloneable {
        ...
        public Map(string n1, string n2, double weight) {
            N1 = n1;
            N2 = n2;
            Weight = weight;
        }
